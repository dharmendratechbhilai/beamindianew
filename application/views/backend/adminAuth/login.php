        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <form class="row g-3" action="<?= base_url('do-admin-login') ?>" method="post">
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="rememberMe"><small>Please accept our <a href="#!">Privacy policy</a> to proceed with login procedures.</small></label>
                      </div>
                    </div>
                    <div class="col-12">
