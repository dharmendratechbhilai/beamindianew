              ...
              <tbody>
                <?php foreach ($employeesLeaveData as $key => $leave) { ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url('company-accept-leave/') . $leave['id'] ?>" class="btn btn-sm btn-success"><i class="bi bi-bookmark-check"></i></a>
                      <a href="<?= base_url('company-reject-leave/') . $leave['id'] ?>" class="btn btn-sm btn-danger"><i class="bi bi-x-circle"></i></a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
