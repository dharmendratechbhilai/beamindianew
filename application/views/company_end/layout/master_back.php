...
<head>
  ...
  <?php include_once 'application/views/company_end/shared/css.php'; ?>
...
<body>
  ...
  <?php include_once 'application/views/company_end/shared/header.php'; ?>

  <?php include_once 'application/views/company_end/shared/sidebar.php'; ?>

  <?= $content; ?>

  <?php include_once 'application/views/company_end/shared/footer.php'; ?>

  <?php include_once 'application/views/company_end/shared/js.php'; ?>
